...
sudo apt-get install -y cmake ccache ninja-build libeigen3-dev libgdal-dev libceres-dev libgtest-dev rapidjson-dev libspdlog-dev libtinyxml2-dev clang-format-11 lcov g++-11 build-essential libunwind-dev git
