...
{
    std::vector<PipelineState> states = {PipelineState::INITIAL_PROCESSING,
                                         PipelineState::INITIAL_GLOBAL_RELAX,
                                         PipelineState::CAMERA_PARAMETER_RELAX,
                                         PipelineState::FINAL_GLOBAL_RELAX,
                                         PipelineState::GENERATE_THUMBNAIL,
                                         PipelineState::GENERATE_GEOTIFF,
                                         PipelineState::COMPLETE};

    std::vector<std::string> state_strings = {"INITIAL_PROCESSING",
